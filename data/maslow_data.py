...
# tag_type(태그타입 - tag, open_tag, open_close_tag)tag_name(태그명), content(내용), props(요소의 속성 및 속성값)
...
maslow_data = [
    ...
    # h2
    {
        "tag_type": "open_close_tag",
        "tag_name": "h2",
        "content": "매슬로우의 욕구 이론에 대해 정리해놓은 것이고 피라미드를 통해 각 단계들을 5단계로 나타내보았다.",
        "props": {},
    },
    # p
    {
