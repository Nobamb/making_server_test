    ...
    # ul(ul_text)
    {
        ...
        "children": [
            # li(ul_text에 사용할 li)
            {
                ...
                "props": {
                    "className": "width100per-height20per back-color-gray-bbb padding-10 opacity0 border-radiuw-10"
                },
            },
            # li(ul_text에 사용할 li)
            {
        ...
        "props": {"className": "full-size position-absolute flex-vertical-arrange off"},
    },
]
