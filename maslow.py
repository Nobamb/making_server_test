    ...
    def do_GET(self):
        ...
        if self.path == "" or self.path == "/":
            ...
            li_level3_title = open_close_tag(
                "h3", childrens=["3단계, 소속감 또는 애정의 욕구"]
            )
            ...
            li_level1_title = open_close_tag(
                "h3", childrens=["1단계, 기본 인권과 관련된 욕구"]
            )
            ...
            li_level5_text = open_close_tag(
                "li",
                types=["class"],
                values=["width100per-height20per"],
                childrens=[
            ...
            # children은 li를 모두 담음
            # 타입명 class
            # 타입값 full-size position-absolute flex-vertical-arrange
            ul_text = open_close_tag(
                "ul",
                types=["class"],
                values=["full-size position-absolute flex-vertical-arrange"],
                childrens=[
                    li_level5_text,
                    li_level4_text,
                    li_level3_text,
