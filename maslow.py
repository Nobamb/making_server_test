...
class MaslowServer(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if self.path == "" or self.path == "/":
            ...
            # open_close_tag
            # 태그명은 h3
            li_level5_title = open_close_tag("h3",childrens=["5단계, 자아실현의 욕구"])
            ...
            li_level5 = open_close_tag(
                ...
                types=["class"],
                values=["width100per-height20per back-color-blue"],
                childrens=[
                    li_level5_title,
            ...
            # open_close_tag
            # 태그명은 h3
            li_level4_title = open_close_tag("h3",childrens=["4단계, 인정의 욕구"])
            ...
            li_level4 = open_close_tag(
                ...
                types=["class"],
                values=["width100per-height20per back-color-green"],
                childrens=[
                    li_level4_title,
            ...
            # open_close_tag
            # 태그명은 h3
            li_level3_title = open_close_tag("h3",childrens=["3단계, 소속감 또는 애정의 욕구"])
            ...
            li_level3 = open_close_tag(
                ...
                types=["class"],
                values=["width100per-height20per back-color-yellow"],
                childrens=[
                    li_level3_title,
            ...
            # open_close_tag
            # 태그명은 h3
            li_level2_title = open_close_tag("h3",childrens=["2단계, 안전과 관련된 욕구"])
            ...
            li_level2 = open_close_tag(
                ...
                types=["class"],
                values=["width100per-height20per back-color-orange"],
                childrens=[
                    li_level2_title,
            ...
            # open_close_tag
            # 태그명은 h3
            li_level1_title = open_close_tag("h3",childrens=["1단계, 기본 인권과 관련된 욕구"])
            ...
            li_level1 = open_close_tag(
                ...
                types=["class"],
                values=["width100per-height20per back-color-red"],
                childrens=[
                    li_level1_title,
            ...
            # childrens로 li들을 받음
            # 타입 class
            # 타입값 gray-bbb, triangle full-size .flex-vertical-arrange position-relative

            ul_triangle = open_close_tag(
                "ul",
                types=["class"],
                values=["triangle back-color-gray-bbb full-size flex-vertical-arrange position-relative"],
            ...
            # children은 li를 모두 담음
            # 타입명 class
            # 타입값 full-size position-absolute
            ul_text = open_close_tag("ul", types=["class"], values =["full-size position-absolute"],childrens=[])
            ...
            div_in_ul = open_close_tag("div",types=["class"],values=["width-1000px height-1000px position-relative"], childrens=[ul_triangle, ul_text])
